...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item">분석데이터 차트
        </li>
      </ol>
      <!-- Area Chart Example-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-area-chart"></i> 연도별 키워드 빈도 수</div>
        <div class="card-body">
      ...
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-bar-chart"></i> 채널별 빈도 수</div>
            <div class="card-body">
        ...
        <div class="col-lg-4">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-pie-chart"></i> 채널별 빈도 수</div>
            <div class="card-body">
    ...
    <script src="./Resouces/js/sb-admin-charts.js"></script>
  </div>
</body>
